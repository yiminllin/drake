...
int DoMain() {
    ...
    MPMParameters::IOParameters io_param {
        "mpm-test",                            // case name
        "/home/yiminlin/Desktop/drake/multibody/fem/mpm-dev/examples/advecting-ball-with-walls/outputs",       // output directory name
    ...
    Vector3<double> left_hand_translation = {-0.15, 0.0, 0.0};
    ...
    Vector3<double> right_hand_translation = {0.15, 0.0, 0.0};
